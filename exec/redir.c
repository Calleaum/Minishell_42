...
/*   Updated: 2025/03/20 11:43:03 by calleaum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int setup_input_redirection(t_node *current)
// {
//     int fd;
...
// int setup_output_redirection(t_node *current)
// {
//     int fd;
//     int flags;
//     t_node *next = current->next;
...
// /* Structure pour stocker les informations de commande */
...
// int count_commands(t_node *tokens)
// {
//     int count = 1;
...
// t_cmd *extract_commands(t_node *tokens, int cmd_count)
// {
...
// int count_command_args(t_node *start, t_node *end)
// {
//     int count = 0;
...
// char **extract_command_args(t_node *start, t_node *end, int arg_count)
// {
...
// int setup_redirections(t_node *start, t_node *end)
// {
//     t_node *current = start;
//     int result;
...
// //         status = ft_export(mini->env, cmd->args);
// //     else if (ft_strcmp(cmd->args[0], "unset") == 0)
// //         status = ft_unset(mini->env, cmd->start, mini);
// //     else if (ft_strcmp(cmd->args[0], "env") == 0)
// //         status = ft_env(mini->env);
